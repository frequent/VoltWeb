...
(function (jIO, RSVP, JSON) {
  ...
  VoltStorage.prototype.get = function (id) {
  ...
  VoltStorage.prototype.hasCapacity = function (name) {
    return (name === "list");
  };

  VoltStorage.prototype.buildQuery = function () {
  ...
  jIO.addStorage('volt_storage', VoltStorage);
