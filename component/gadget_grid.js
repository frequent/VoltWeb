...
(function (window, rJS, RSVP, Math, Date, ics, saveAs, Object, isNaN, navigator) {
  ...
  var MEETING_DIALOG = "event_dialog_template";
  ...
  KLASS
    ...
    .declareMethod("openDialog", function (my_target) {
      ...
      dialog = dict.dialog;
      meetup = dict.event_dict[my_target.event_reference.value];
      ...
      return gadget.stateChange({
        "dialog_pending": true,
        "current_position": meetup.location.coordinates
      })
        .push(function () {
          var lang = dict.selected_language;
          var content = meetup.content_dict[lang];
          var start = new Date(meetup.start_date);
          var venue = meetup["location"];
    ...
    .declareMethod("localiseVenue", function (my_event) {
      var gadget = this;
      return gadget.getDeclaredGadget("meetup")
